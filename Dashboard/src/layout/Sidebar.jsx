...
const Sidebar = () => {
  ...
  const ToggleSidebar=()=>{
    if(data.navbar && data.ScreenSize <=600){
...
<div className='main'>
   <Stack  direction={'column'}  position={{xs :'absolute', sm:'relative'} }   sx={{width: {xs:'300px' ,sm:'300px'},height:"100%", zIndex:999 ,background:"#3d2b4f",
              display:data.navbar?'inline-block': "none",
